...
exports.run = (client, message, params) => {
  ...
  .addField('<:IZBgames:459689915039612928> Fun', '`.roll`, `.master`, `.8ball`, `.hug`, `.kiss`, `.cat`, `.hack`, `.codesecret`,`.say`')
  .addField('<:IZBinfo:459689946513408000> Infos',' `.stats`, `.invite`, `.serveurinfo`, `.site`, `.discord`, `.ping`, `.help`, `.profile`, `.google`, `.avatar`, `.partenariat`')
